...
const footerSections = [
    ...
    },
    {
        sectionName: 'Contact',
        items: [
            {title:'Chandigarh University, Gharuan, Punjab',link:"#"},
            {title:'(+91) 9400000000',link:"#"},
            {title:'ruchi357073@gmail.com',link:"#"}
        ]
    }
];
const featuresSec = [
...
const testimonial = {
    ...
    name:'RUCHI SHARMA',
    position:'Developer',
    description:'Welcome to our online store. Explore our wide range of products crafted with care and delivered with trust.'
