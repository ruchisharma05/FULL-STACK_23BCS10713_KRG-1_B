    ...
    <>
            ...
            <div className='flex gap-2 mt-4 mb-4'>
                {socialMedia.map((each,index)=>
                    <a key={index} href={each === 'linkedin' ? 'https://www.linkedin.com/in/ruchi-sharma-91a40428a' : `https://www.${each}.com`} target="_blank" className='text-[16px] text-silver bg-gray-200 w-[40px] h-[40px] rounded-lg hover:bg-salmon hover:text-white'>
